...
namespace HelloTests
{
    ...
    public class HelloContractTests : IClassFixture<CheckpointFixture<HelloContractTests>>
    {
        readonly CheckpointFixture fixture;
        readonly ExpressChain chain;

        public HelloContractTests(CheckpointFixture<HelloContractTests> fixture)
        {
            this.fixture = fixture;
            this.chain = fixture.FindChain("HelloTests.neo-express");
        }
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<HelloContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<HelloContract>(c => c.changeNumber(42));
            ...
            var storages = snapshot.GetContractStorages<HelloContract>();
            var contractStorage = storages.StorageMap("HelloContract");
