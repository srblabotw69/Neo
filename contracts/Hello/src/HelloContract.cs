...
namespace Hello
{
    [DisplayName("YourName.HelloContract")]
    ...
    {
        private static StorageMap ContractStorage => new StorageMap(Storage.CurrentContext, "HelloContract");
        ...
        [DisplayName("_deployHello")]
        public static void DeployHello(object data, bool update)
        {
            if (!update)
            {
                ContractMetadata.Put("Owner", (ByteString) Tx.Sender);
